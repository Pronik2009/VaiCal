 ...
 */
final class Version20210422152814 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE year ADD city_id INT NOT NULL');
        $this->addSql('ALTER TABLE year ADD CONSTRAINT FK_BB8273378BAC62AF FOREIGN KEY (city_id) REFERENCES city (id)');
        $this->addSql('CREATE INDEX IDX_BB8273378BAC62AF ON year (city_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_BB8273378BAC62AF ON year');
        $this->addSql('ALTER TABLE year DROP city_id');
    }
}
